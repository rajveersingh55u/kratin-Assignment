...
const Hero = () => {
    return (
        <div>
            <div className='absolute top-16 bg-darksky-50'>
                <div style={{ backgroundImage: `url(${nature})` }}>
                    <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 ">
                        ...
                        <p className="mt-6 mb-8 text-md  sm:mb-12 xl:max-w-2xl text-blue-700">Here is mantra for you to stay heathy and happy. Start with some light exercise and yoga, follow your diet and enjoy with music and movies. </p>
                    </div>
                </div>
                {/* 480x320 */}
                ...
                <div className='h-60 -mt-32 -z-50 '>
                    <p className='w-full pb-4 absolute text-red-600 text-center bottom-0 bg-green-100'>
                        <a href="https://github.com/rajveersingh55u">Made by Rajveersingh  </a>
                    </p>
                </div>
                ...
                <div className=" -mt-48 mb-10 py-4 px-4 pt-16 bg-green-100 flex flex-col items-center text-center">
                    <div className='max-w-4xl text-lg px-4'>
                        ...
                        <ul className='list-decimal text-gray-700'>
                            <li className='hover:text-orange-600'>Get active</li>
                            <li className='hover:text-oranger-600'>Take supplements as necessary</li>
                            <li className='hover:text-orange-600'>Eat a healthy diet</li>
                            <li className='hover:text-orange-600'>Wash your hands frequently</li>
                            <li className='hover:text-orange-600'>Learn how to manage stress</li>
                            <li className='hover:text-orange-600'>Get plenty of rest</li>
                            <li className='hover:text-orange-600'>Take steps to prevent infections</li>
                            <li className='hover:text-orange-600'>Schedule annual physicals</li>
                            <li className='hover:text-orange-600'>Avoid contact with people who are sick</li>
                        </ul>
                    </div>
